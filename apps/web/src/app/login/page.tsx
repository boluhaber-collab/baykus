      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between p-10 border-r border-slate-800">
        <div>
          ...
          <p className="mt-6 text-slate-400 max-w-md text-sm leading-relaxed">
            Sipariş, teklif, stok, cari ve finans süreçlerini masaüstü Baykuş deneyimine yakın
            bir web arayüzünde yönetin.
          </p>
        </div>
        <div className="text-xs text-slate-500">© Baykuş Baskı ERP</div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10 bg-gradient-to-br from-baykus-splash via-slate-900 to-slate-800">
        <div className="w-full max-w-md rounded-2xl border border-baykus-line bg-white shadow-xl p-8">
          <div className="text-center mb-7 lg:hidden">
            ...
            <h1 className="text-xl font-bold text-baykus-text">BAYKUŞ BASKI</h1>
            <p className="text-xs text-baykus-muted mt-1 uppercase tracking-wider">İşletme Programı</p>
          </div>
          <div className="hidden lg:block mb-6">
            <h2 className="text-lg font-semibold text-baykus-text">Giriş</h2>
            <p className="text-sm text-baykus-muted">Hesabınızla oturum açın</p>
          </div>
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="bk-btn-primary w-full py-2.5">
