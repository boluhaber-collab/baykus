...
import { ReceivableItem, apiFetch, formatMoney } from "@/lib/api";
    ...
    <div>
      <div className="flex flex-wrap items-end justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-slate-500 text-sm">Bakiyesi 0&apos;dan büyük müşteriler</p>
        </div>
      ...
      <div className="mb-4 rounded-xl border border-amber-200 bg-amber-50 px-5 py-4 flex flex-wrap gap-6">
        <div>
        ...
        <div>
          <div className="text-xs text-amber-800">Müşteri sayısı</div>
          <div className="text-xl font-bold text-amber-900">{items.length}</div>
        </div>
      </div>
